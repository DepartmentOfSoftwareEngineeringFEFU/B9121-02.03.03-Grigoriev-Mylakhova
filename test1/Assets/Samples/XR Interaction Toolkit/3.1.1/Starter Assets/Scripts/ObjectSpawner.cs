...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.StarterAssets
{
    ...
    public class ObjectSpawner : MonoBehaviour
    {
        ...
        [SerializeField]
        [Tooltip("Панель с пошаговой инструкцией")]
        ...
        [SerializeField]
        [Tooltip("Родитель для всех размещённых объектов мебели (используется для сохранения)")]
        ...
        public bool TrySpawnObject(Vector3 spawnPoint, Vector3 spawnNormal)
        {
            ...
            // 1. Создаём объект (без родителя)
            var newObject = Instantiate(m_ObjectPrefabs[objectIndex]);

            // 2. Устанавливаем позицию и поворот
            ...
            // 3. Устанавливаем родителя (PlacedObjects)
            newObject.transform.SetParent(objectsParent);

            // 4. Если нужно – спавним визуализацию
